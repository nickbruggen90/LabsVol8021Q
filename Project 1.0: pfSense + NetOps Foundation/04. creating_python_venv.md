...
1. We will need to install Paramiko and SCP inside a virtual environment (VENV) to allow it to function.
```
...
```
3. To execute this script, we need to add the script to the shared folder for accessibility. [You can find the shared folder guide here.]
